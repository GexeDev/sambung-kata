-- =========================================================
-- FILTER KATA - AUTO KETIK (VIRTUAL INPUT)
-- =========================================================
...
local serverLetter = ""  -- AWALAN dari game
local akhiranInput = ""  -- AKHIRAN dari search bar
local hasilFilter = {}
local isTyping = false  -- Lagi ngetik atau nggak
...
local function autoType(kata)
    ...
    -- Kasih delay biar gak kecepatan
    task.wait(0.1)
    ...
    for i = 1, #kata do
        ...
        if keyCode then
            ...
            task.wait(0.05)  -- delay antar huruf
            VirtualInputManager:SendKeyEvent(false, keyCode, false, game)
            task.wait(0.03)
        end
    end
    
    -- Delay bentar sebelum enter
    task.wait(0.1)
...
searchBox.PlaceholderText = "+akhiran"
searchBox.Text = ""
...
footerFrame.Size = UDim2.new(1, -10, 0, 25)
footerFrame.Position = UDim2.new(0, 5, 0, 165)
...
totalLabel.Size = UDim2.new(1, -10, 1, 0)
...
print("📌 Klik kata → auto ketik + enter")
