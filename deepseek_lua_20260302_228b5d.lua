-- =========================================================
-- ENTER BOT V4 - ENTER DI ATAS KANAN (FIXED POSITION)
-- =========================================================
...
-- =========================
-- BUAT GUI (FIXED POSITION, TIDAK MENYESUAIKAN)
-- =========================
...
enterFrame.Position = UDim2.new(1, -170, 0.02, 0)  -- ATAS KANAN!
...
-- INIT
-- =========================
print("🚀 ENTER BOT V4 SIAP!")
print("📌 Preview kata: ATAS TENGAH (200x50)")
print("📌 Tombol Enter: ATAS KANAN (150x70) - FIXED POSITION")
print("📌 Gak bakal pindah-pindah!")