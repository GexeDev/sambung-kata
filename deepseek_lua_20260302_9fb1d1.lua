-- =========================================================
-- ENTER BOT V3 - PREVIEW KECIL, ENTER GEDE + DETEKSI FIX
-- =========================================================
...
-- =========================
-- DETEKSI REMOTE MATCHUI (LANGSUNG DARI JEMPUT.LUA)
-- =========================
if MatchUI then
    ...
    warn("⚠️ MatchUI tidak ditemukan! Pakai fallback attribute...")
...
-- =========================
-- 1. PREVIEW KATA (DIPERKECIL: 200x50)
-- =========================
...
-- =========================
-- 2. TOMBOL ENTER (DIGEDEIN: 150x70, DITURUNIN)
-- =========================
local enterFrame = Instance.new("Frame")
enterFrame.Name = "FakeEnter"
enterFrame.Size = UDim2.new(0, 150, 0, 70)  -- lebih gede
enterFrame.Position = UDim2.new(1, -170, 1, -90)  -- diturunin
...
spawn(function()
    ...
    for _, gui in ipairs(LocalPlayer.PlayerGui:GetChildren()) do
        ...
        if enterBtn and enterBtn:IsA("TextButton") then
            ...
            print("✅ Tombol Enter asli ditemukan")
            found = true
            break
        end
    end
    ...
    if not found then
        print("ℹ️ Pakai posisi default (kanan bawah)")
    end
end)
...
-- INIT
-- =========================
print("🚀 ENTER BOT V3 SIAP!")
print("📌 Preview kata: 200x50 (di atas)")
print("📌 Tombol Enter: 150x70 (kanan bawah)")
print("📌 Deteksi match: PAKE REMOTE ASLI")