-- =========================================================
-- ENTER BOT FINAL - MINIMAL 4 HURUF
-- =========================================================
...
-- =========================
-- FUNGSI CARI KATA (TERPENDEK + MIN 4 HURUF)
-- =========================
local function getKata(prefix)
    ...
    if #candidates > 0 then
        -- PILIH YANG TERPENDEK (tapi tetap >=4)
...
if MatchUI then
    MatchUI.OnClientEvent:Connect(function(cmd, value)
        ...
        elseif cmd == "UpdateServerLetter" then
            ...
            print("🎯 Huruf awal:", serverLetter, "→ Kata (min 4):", kataTerpilih)
...
enterFrame.InputEnded:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        print("✅ MENGIRIM KATA (min 4 huruf):", kataTerpilih)
